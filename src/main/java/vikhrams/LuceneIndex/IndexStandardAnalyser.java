...
public class IndexStandardAnalyser {
    // Directory where the search index will be saved
    private static String INDEX_DIRECTORY = "../indexStandard";

    public void Index_standard(String arg) throws IOException {
        //stop words sets
        ...
        //Standard Analyzer used by the query parser.
        ...
        System.out.printf("Indexing using Standard Analyzer \"%s\"\n", arg);
        try {
